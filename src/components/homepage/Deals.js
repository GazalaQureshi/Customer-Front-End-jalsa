              ...
              <div >
                ...
                <img  src={img} alt="trendimg" style={{ objectFit: "cover", margin: "auto",width:"100%",height:"100%" }} />
                  ...
                  <div className='' style={{ background: "rgb(240,240,240)",paddingTop:".5rem" }}>
                    <h1 className="shop-trend-image-heading" style={{ textAlign: "center", marginTop: "0rem", marginBottom: "0rem" }}>{title}</h1>
                    <h2 className="shop-trend-image-heading-2" style={{ textAlign: "center", marginTop: ".2rem", paddingBottom: "0.4rem" }}>upto <b>65%</b> off</h2>
                  </div>
                </div>
              </div>
            )
