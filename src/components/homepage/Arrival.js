  ...
  return (
    <div style={{ paddingLeft: "2rem", paddingRight: "2rem" }}>
      ...
      <div className="arrival-container" style={{ display: "flex",width:"100%"}}>
        ...
        <div className='arr-img1' style={{ width: "33%", marginRight: "1%" }}>
          <img src={arrivalimg1} alt="img1" width="100%" style={{ objectFit: "cover" }} />
        </div>

        <div className='arr-img2' style={{ width: "33%" }}>
          <img src={arrivalimg2} alt="img2" className='arr-imgd2' style={{ display: "block", height:"50%",objectFit: "cover", width: "100%",marginBottom:"5%" }} />
        ...
        <div style={{ width: "36%" ,display: "flex", justifyContent: "center", marginLeft: ".3rem" , alignItems: "center", background: "rgb(241, 230, 239)" }}>
