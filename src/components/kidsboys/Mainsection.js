            ...
            <div className='kb-detail' >
                {
                    items.map((m) => {
                        ...
                        return (<div className='kb-info' key={id} >

                            <div className='kb-img-sec'>
                            
                            <div className='img-div'><Link to={`/kids-boys/${id}`} ><img src={img} alt="iiimg" className='kb-img' style={{width:"100%",height:"100%",objectFit:"cover"}} /></Link></div>
                            ...
                            <div className='kb-detail-sec'>
                                <h4 className='kb-kalki'>{title}</h4>
                                <p className='kb-discription'>{discription}</p>
                                <h4 className='kb-rate'><span className='kb-rate-mrp'>₹<s>{mrp}</s></span><span className='kb-rate-sp'>₹ {sp}</span> </h4>
                                
                                <div className='kb-flex-ratings' >
                                    <div className='kb-flex-ratings-a'>
                                    <p className='kb-rev-star'><AiFillStar color="white"/> {star}</p>
                                    <p className='kb-flex-num'>{review}  reviews</p>
                                    </div>
                                    <p className='kb-flex-icons'><BsFillShareFill color=" blue" className='share-icon'/></p>
                                </div>
                            </div>
                        </div>)
                    })
