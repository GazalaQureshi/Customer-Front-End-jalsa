...
const Aside = () => {
  ...
  return (
    <div> 
      <h2 ><Link to="/kids-girls" style={{color:"gray", textDecoration:"none"}}>SHOP GIRLS</Link></h2>
      ...
      <div className="mens-checkbox">
        ...
        <label className="mens-label" htmlFor="mens-a" >Sherwanis (131)</label>
        </div>
        <div style={{ display: "flex",alignItems:"center", marginBottom: ".3rem" }}>
        <input type="checkbox" id="mens-b" className="mens-box" />
        <label className="mens-label" htmlFor="mens-b" >Kurta Jacket Shirt (131)</label>
        </div>
        <div style={{ display: "flex",alignItems:"center", marginBottom: ".3rem" }}>
        <input type="checkbox" id="mens-c" className="mens-box" />
        <label className="mens-label" htmlFor="mens-c" >Kurta Sets (131)</label>
        </div>
        <div style={{ display: "flex",alignItems:"center", marginBottom: ".3rem" }}>
        ...
        <label className="mens-label" htmlFor="mens-e" >Kurtas (131)</label>
        </div>
        <div style={{ display: "flex",alignItems:"center", marginBottom: ".3rem" }}>
        <input type="checkbox" id="mens-f" className="mens-box" />
        <label className="mens-label" htmlFor="mens-f" >Indowestern (131)</label>
        </div>
      </div>
      <div className="mens-checkbox">
        ...
        <label className="mens-label" htmlFor="mens-i" >Reception</label>
        </div>
        <div style={{ display: "flex",alignItems:"center", marginBottom: ".3rem" }}>
        <input type="checkbox" id="mens-j" className="mens-box" />
        <label className="mens-label" htmlFor="mens-j" >Cocktail</label>
        </div>
        <div style={{ display: "flex",alignItems:"center", marginBottom: ".3rem" }}>
        <input type="checkbox" id="mens-k" className="mens-box" />
        <label className="mens-label" htmlFor="mens-k" >Mehendi</label>
        </div>
