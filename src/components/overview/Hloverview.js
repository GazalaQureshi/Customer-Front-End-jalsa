...
import Similarproducts from "./hl_similar_recently/Similarproducts";
import Recentlyviewed from "./hl_similar_recently/Recentlyviewed";
...
const Hloverview = () => {
  ...
  const selectedMenData = hldata.find((singlemen) => singlemen.id === Number(id));
