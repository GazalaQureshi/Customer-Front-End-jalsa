...
import Similarproducts from "./kb_similar_recently/Similarproducts";
import Recentlyviewed from "./kb_similar_recently/Recentlyviewed";
...
const Kboverview = () => {
  ...
  const selectedMenData = kbdata.find((singlemen) => singlemen.id === Number(id));
