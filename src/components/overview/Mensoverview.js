...
import Similarproducts from "./mens_similar_recently/Similarproducts";
import Recentlyviewed from "./mens_similar_recently/Recentlyviewed";
...
const Mensoverview = () => {
  ...
  let month = "June"; //enter month eg  "January,April"
  ...
  const selectedMenData = mensdata.find((singlemen) => singlemen.id === Number(id));
        ...
        XL
                    ...
                    <div className="ov-spoffer">
                      ...
                      <p className="ov-offers">
                        <ImTicket /> Buy 1 Get 2
                      </p>
                      <p className="ov-offers"
                      >
                        <ImTicket /> Use Code "HELLO" For 10% Off
                      </p>
                      <p className="ov-offers"
                      >
                        <ImTicket /> Coupon Discount: Rs. 140 Off (Check Cart)
                      </p>
                    </div>
