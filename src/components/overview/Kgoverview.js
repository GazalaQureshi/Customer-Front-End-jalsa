...
import Similarproducts from "./kg_similar_recently/Similarproducts";
import Recentlyviewed from "./kg_similar_recently/Recentlyviewed";
...
const Kgoverview = () => {
  ...
  const selectedMenData = kgdata.find((singlemen) => singlemen.id === Number(id));
