    ...
    return (
        <div>
          { showsection ? 
            ...
            <div className='mens-detail' style={{marginRight:"1rem"}}>
                {
                    items.map((m) => {
                        ...
                        return (<div className='mens-info' key={id} >  
                            ...
                            <div className='mens-img-sec'>
                                <div  className='img-div'><Link to={`/mens/${id}`} ><img src={img} alt="iiimg" style={{width:"100%",height:"100%",objectFit:"cover"}}/></Link></div>
                            ...
                            <div className='mens-detail-sec'>
                                ...
                                <h4 className='mens-rate' style={{alignItems:"center"}}><span className='mens-rate-mrp'>₹<s>{mrp}</s></span><span className='mens-rate-sp'>₹ {sp}</span> </h4>
                                
                                <div className='mens-flex-ratings'>
                                    <div className='mens-flex-ratings-a' style={{}}>
